...
<html>
    ...
    <body>
        ...
        <div class="grid-productos">
            <%--
            Recorre la lista de productos que recupera mediante el objeto "productoServices" 
             que es inyectado por CDI (alcance aplicación) 
            --%>
            <c:forEach var="producto" items="${productoServices.productos}">
            <div class="producto">
