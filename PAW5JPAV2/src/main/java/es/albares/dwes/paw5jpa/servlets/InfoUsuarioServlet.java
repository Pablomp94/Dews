 ...
 * @author eloy
 */
@WebServlet(name = "InfoUsuarioServlet", urlPatterns = {"/usuario/infoUsuario"})
public class InfoUsuarioServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(usuarioBean.esValido()){
            ...
            request.setAttribute("error", "¡Error, para acceder a tus datos primero debes autenticarte!");
