...
import es.albares.dwes.paw5jpa.database.GestorEntityManager;
    ...
    private List<Producto> getStaticProducts() {
        ...
        listaProductos.add(
            ...
            """,
                        ...
                        BigDecimal.valueOf(749), catMovil));
        ...
        listaProductos.add(
            ...
            <li>Carga rápida de 25W<br><strong>*<span style="text-decoration: underline;">Cargador no incluido</span></strong></li>
                        ...
                        new GregorianCalendar(2023, 5, 1).getTime(),
                        BigDecimal.valueOf(469.01), catMovil));
        ...
        listaProductos.add(
            ...
            <li>Carga inalámbrica 30W</li>
                        ...
                        new GregorianCalendar(2023, 10, 1).getTime(),
                        BigDecimal.valueOf(954.99), catMovil));
        ...
        listaProductos.add(
            ...
            <li><strong>Caja: </strong>Cable USB C</li>
                        ...
                        new GregorianCalendar(2023, 7, 12).getTime(),
                        BigDecimal.valueOf(2029.90), catMovil));
