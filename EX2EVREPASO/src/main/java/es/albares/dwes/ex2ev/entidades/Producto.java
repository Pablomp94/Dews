...
public class Producto implements Serializable  {
    ...
    public ProductoExistencias getExistencias() {
        return existencias;
    }

    public void setExistencias(ProductoExistencias existencias) {
        this.existencias = existencias;
    }
    
    public int getNumeroExistencias() {
        ProductoExistencias exist = this.getExistencias();
        if (exist != null) {
            return exist.getCantidad();
        } else {
            return 0;
        }
    }
