...
import es.albares.dwes.ex2ev.dao.AficionDAO;
import es.albares.dwes.ex2ev.dao.DireccionDAO;
import es.albares.dwes.ex2ev.dao.ProvinciaDAO;
import es.albares.dwes.ex2ev.dao.UsuarioDAO;
import es.albares.dwes.ex2ev.entidades.Aficion;
import es.albares.dwes.ex2ev.entidades.Direccion;
import es.albares.dwes.ex2ev.entidades.Sexo;
