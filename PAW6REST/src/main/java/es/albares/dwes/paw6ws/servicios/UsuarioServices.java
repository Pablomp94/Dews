...
import es.albares.dwes.paw6ws.dao.AficionDAO;
import es.albares.dwes.paw6ws.dao.DireccionDAO;
import es.albares.dwes.paw6ws.dao.ProvinciaDAO;
import es.albares.dwes.paw6ws.dao.UsuarioDAO;
import es.albares.dwes.paw6ws.entidades.Aficion;
import es.albares.dwes.paw6ws.entidades.Direccion;
import es.albares.dwes.paw6ws.entidades.Sexo;
